...
class Carro{
	public:
		...
		byte sennsorechoC  = 11; //Sensor Ultrasonido Central Echo
		...
		static void contarRuedaI(); //Metodo para registrar con la interrupcion en Constructor
		static void contarRuedaD();
